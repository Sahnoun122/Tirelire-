...
import { createGroup, getGroup, listGroups , joinGroup ,leaveGroup , startRound , contribute , getHistory} from "../controllers/group.controller.js";
...
router.get("/history/:id", authenticateToken, getHistory);
